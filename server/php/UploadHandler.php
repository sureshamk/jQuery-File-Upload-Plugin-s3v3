...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $client = S3Client::factory([
            'credentials' => [
                'key' => 'XXXXXXXXXXXXXXXXXXX', // security key
                'secret' => 'XXXXXXXXX', // secret key
            ],
            'region' => 'ap-southeast-1', // add ur region
            'version' => 'latest' // add your version
        ]);

        $this->s3 = $client->registerStreamWrapper();
        ...
        $this->prefix='1/'; //note there is no "folders" in S3 though you can prefix files with a string that resembles a file system.
        $this->bucket="staging-zuppudy";
